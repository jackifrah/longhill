  ...
  return (
    <div className="container py-12 flex justify-center">
      <div className="mx-auto max-w-4xl">
        <div className="grid md:grid-cols-2 items-start mb-16 hover:shadow-lg rounded-xl transition-shadow duration-300 p-4">
