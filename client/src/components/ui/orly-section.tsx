...
export function OrlySection() {
  return (
    <div className="w-full py-12">
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-12 hover:transform hover:scale-[1.02] transition-transform duration-300">
        <img 
          src={orlyLogoSvg}
          alt="Orly AI"
          className="h-12 md:h-16 object-contain"
        />
        <p className="text-base leading-relaxed text-purple-700/90 dark:text-purple-300 font-medium">
